...
export default function CountryDetail() {
  ...
  if (!data) {
    return (
      <section className="py-32 text-center">
        <h2 className="text-2xl font-semibold text-[#0A3A5E]">Country not found</h2>
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-slate-50">
      {/* HERO */}
      <section className="bg-gradient-to-r from-[#0A3A5E] to-[#0A3A5E] text-white py-32">
      ...
      {/* BLUE STRIP */}
      <section className="bg-[#0A3A5E] py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="h-8" />
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="premium-card bg-gradient-to-br from-blue-50 to-purple-50 min-h-96 flex items-center justify-center rounded-xl border-2 border-blue-100">
              <div className="text-center">
                <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-[#0A3A5E] flex items-center justify-center">
                ...
                <div className="premium-card premium-card:hover cursor-pointer border-l-4 border-[#F5A623]" onClick={() => toggleExpanded(`uni-${idx}`)}>
                  <div className="flex gap-4 items-start mb-4">
                    ...
                    <div className="flex-1">
                      <h4 className="font-bold text-lg text-[#0A3A5E] mb-1">{uni}</h4>
              ...
              <div key={course} className="group" onClick={() => toggleExpanded(`course-${idx}`)}>
                <div className="premium-card premium-card:hover cursor-pointer border-l-4 border-[#F5A623]">
                  <div className="flex gap-3 items-start mb-3">
                    ...
                    <h4 className="font-bold text-base text-[#0A3A5E]">{course}</h4>
                  </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {data.intakes.map((intake: string) => (
              <div key={intake} className="premium-card text-center border-t-4 border-[#F5A623]">
                ...
                <h4 className="font-bold text-xl text-[#0A3A5E]">{intake}</h4>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="premium-card border-l-4 border-[#F5A623]">
              <div className="flex gap-4 mb-6">
                ...
                <div>
                  <h4 className="font-bold text-lg text-[#0A3A5E]">{data.visa.type}</h4>
              ...
              <div className="space-y-4 mb-4">
                <div>
                  <p className="font-semibold text-[#0A3A5E] text-sm">Processing Time</p>
                  <p className="text-gray-700 text-sm mt-1">{data.visa.processTime}</p>
                </div>
                <div>
                  <p className="font-semibold text-[#0A3A5E] text-sm">Description</p>
                  <p className="text-gray-700 text-sm mt-1">{data.visa.description}</p>
                </div>
              </div>

              <div className="border-t border-gray-200 pt-4">
                <p className="font-semibold text-[#0A3A5E] text-sm mb-3">Key Requirements</p>
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="premium-card border-l-4 border-[#0A3A5E]">
              <div className="flex gap-4 items-start mb-6">
                <div className="premium-icon flex-shrink-0">
                  <Briefcase size={32} />
                </div>
                <h4 className="font-bold text-lg text-[#0A3A5E] pt-2">During Studies</h4>
              </div>
            ...
            <div className="premium-card border-l-4 border-[#F5A623]">
              <div className="flex gap-4 items-start mb-6">
                ...
                <h4 className="font-bold text-lg text-[#0A3A5E] pt-2">After Graduation</h4>
              </div>
              <div className="space-y-3 text-sm text-gray-700">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="premium-card border-l-4 border-[#0A3A5E]">
              <div className="flex gap-4 items-start mb-6">
                ...
                <h4 className="font-bold text-lg text-[#0A3A5E]">Monthly Breakdown</h4>
              </div>
            ...
            <div className="premium-card bg-gradient-to-br from-orange-50 to-amber-50 border-l-4 border-[#F5A623]">
              <div className="flex gap-4 items-start mb-6">
                ...
                <h4 className="font-bold text-lg text-[#0A3A5E]">Money-Saving Tips</h4>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="premium-card border-l-4 border-[#F5A623]">
            <div className="flex gap-4 items-start mb-6">
              ...
              <h4 className="font-bold text-lg text-[#0A3A5E]">Available Scholarships</h4>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="premium-card border-l-4 border-[#0A3A5E]">
              <div className="flex gap-4 items-start mb-6">
                ...
                <h4 className="font-bold text-lg text-[#0A3A5E]">Top Industries</h4>
              </div>
              <div className="flex flex-wrap gap-2">
                {data.jobMarket?.topIndustries.map((industry: string) => (
                  <span key={industry} className="px-3 py-1 bg-[#0A3A5E] text-white text-xs font-semibold rounded-full">
                    {industry}
                  </span>
                ))}
              </div>
            ...
            <div className="premium-card border-l-4 border-[#F5A623]">
              <div className="flex gap-4 items-start mb-6">
                ...
                <h4 className="font-bold text-lg text-[#0A3A5E]">Employment Rate</h4>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {data.bestCities?.slice(0, 3).map((city: { name: string; description: string }) => (
              <div key={city.name} className="premium-card border-l-4 border-[#0A3A5E]">
                <div className="flex gap-3 items-start mb-4">
                  <div className="premium-icon flex-shrink-0">
                    <MapPin size={28} />
                  </div>
                  <h4 className="font-bold text-lg text-[#0A3A5E]">{city.name}</h4>
                </div>
      ...
      {/* CTA */}
      <section className="bg-gradient-to-r from-[#0A3A5E] to-[#0A3A5E] text-white py-24">
